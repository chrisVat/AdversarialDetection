...
def get_model(model:str, num_classes:int, load=False):
    ...
    if model == 'resnet32-cifar10':
        ...
        result.load_state_dict(torch.load('./trained_models/best_models/resnet32-cifar10/cifar10_resnet32-cifar10_99.pth'))
        return result
    elif model == 'resnet50':
...
if __name__ == "__main__":
    ...
    parser.add_argument('--steps_per_update', type=int, default=8, help='Number of steps per each epoch (For minibatching to save memory)')
